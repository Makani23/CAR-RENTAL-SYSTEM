...
public class CarRentalSystem {
    public static void main(String[] args) {
        ...
        // Adding some cars
        agency.addCar(new Car("C1", "Lambo", "Benz", 2020, 50));
        agency.addCar(new Car("C2", "Mitsubishi", "Suzuki", 2019, 45));

        // Adding some customers
        agency.addCustomer(new Customer("CU1", "SDam Doe", "sam@example.com", "1234567890"));
        agency.addCustomer(new Customer("CU2", "Janet Smith", "janet@example.com", "0987654321"));
